...
{
	public static var psychEngineVersion:String = '1.2.0h'; //hotfix release now
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "Vs Stupid v" + psychEngineVersion, 12);
