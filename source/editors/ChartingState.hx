...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var player4DropDown = new FlxUIDropDownMenuCustom(player1DropDown.x + 180, gfVersionDropDown.y + 80,
			FlxUIDropDownMenuCustom.makeStrIdLabelArray(characters, true), function(character:String)
		{
		...
		tab_group_song.add(new FlxText(player4DropDown.x, player4DropDown.y - 35, 0, '4th Opponent:'));
